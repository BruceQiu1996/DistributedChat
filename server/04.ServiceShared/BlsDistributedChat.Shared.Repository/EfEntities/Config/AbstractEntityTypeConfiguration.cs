...
{
    public abstract class AbstractEntityTypeConfiguration<TEntity, TKey> : IEntityTypeConfiguration<TEntity> where TEntity : Entity<TKey>
    {
        ...
        protected virtual void ConfigureQueryFilter(EntityTypeBuilder<TEntity> builder, Type entityType)
        {
            ...
            {
                builder.Property("IsDeleted").HasDefaultValue(false).HasColumnOrder(2);
